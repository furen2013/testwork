#ifndef ASIO_TCPBASESESSION_HEAD
#define ASIO_TCPBASESESSION_HEAD
#pragma once
...
protected:
	...
	bool m_security;
	unsigned int m_message_basic_head_len;
	unsigned int m_message_head_len;
	unsigned int m_queue_message_limit_size;
};
