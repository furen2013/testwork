...
public:
	...
	void add_cb( _Fun f, _Inst i )
	{
		...
		m_listcb.push_back( create_call_back( boost::bind( f, i ) ) );
	}
	...
	{
		boost::mutex::scoped_lock lock( m_mutex );
		m_listcb.push_back( create_call_back( boost::bind( f, i, a1 ) ) );
	}
	...
	{
		boost::mutex::scoped_lock lock( m_mutex );
		m_listcb.push_back( create_call_back( boost::bind( f, i, a1, a2 ) ) );
	}
	...
	{
		boost::mutex::scoped_lock lock( m_mutex );
		m_listcb.push_back( create_call_back( boost::bind( f, i, a1, a2, a3 ) ) );
	}
	...
	{
		boost::mutex::scoped_lock lock( m_mutex );
		m_listcb.push_back( create_call_back( boost::bind( f, i, a1, a2, a3, a4 ) ) );
	}
	...
	{
		boost::mutex::scoped_lock lock( m_mutex );
		m_listcb.push_back( create_call_back( boost::bind( f, i, a1, a2, a3, a4, a5 ) ) );
	}
	...
	{
		boost::mutex::scoped_lock lock( m_mutex );
		m_listcb.push_back( create_call_back( boost::bind( f, i, a1, a2, a3, a4, a5, a6 ) ) );
	}
};
