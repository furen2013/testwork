...
std::string AnisToUTF8(const std::string& str)
{
	...
	//Ansi 转换为 Unicode
	int usLen = (unsigned short)MultiByteToWideChar(936, 0, str.c_str(), str.size(), (wchar_t*)acUnicode, sizeof(acUnicode)/2);

	//Unicode 转换为 Utf8
	usLen = (unsigned short)WideCharToMultiByte(CP_UTF8, 0, (const wchar_t*)acUnicode, usLen, acUTF8, sizeof(acUTF8), NULL, false);
