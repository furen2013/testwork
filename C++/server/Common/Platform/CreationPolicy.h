/* 
 * Copyright (C) 2005-2008 SUNYOU <http://www.mangosproject.org/>
 *
...
#ifndef SUNYOU_CREATIONPOLICY_H
#define SUNYOU_CREATIONPOLICY_H
...
namespace SUNYOU
{
     ...
     */
    template <class T>
        class SUNYOU_DLL_DECL OperatorNew
    {
        public:
     ...
     */
    template <class T>
        class SUNYOU_DLL_DECL LocalStaticCreation
    {
        union MaxAlign
        {
            char t_[sizeof(T)];
     ...
     */
    template<class T>
        class SUNYOU_DLL_DECL CreateUsingMalloc
    {
        public:
            static T* Create()
            {
    ...
    template<class T, class CALL_BACK>
        class SUNYOU_DLL_DECL CreateOnCallBack
    {
        public:
            static T* Create()
            {
